...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    description: 'FOOT WEAR offers premium footwear for every occasion — from casual sneakers to formal elegance.',
    coverImage: 'https://images.unsplash.com/photo-1460353581641-37baddab0fa2?w=1400&q=85&fit=crop',
    logo: '/logos/footwear.jpeg',
    logoBg: 'dark',
    accentColor: '#16C47F',
    category: 'Shoes',
    productCount: 0,
  ...
  },
  {
    ...
    name: 'CLEAN FITS',
    slug: 'cleanfits',
    tagline: 'Clean Style, Perfect Fit',
    description: 'CLEAN FITS delivers premium clothing with minimal, clean aesthetics. High-quality fabrics, modern cuts, and timeless designs that fit perfectly. Look sharp without trying too hard.',
    coverImage: 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=1400&q=85&fit=crop',
    logo: '/logos/cleanfits.jpeg',
    logoBg: 'dark',
    accentColor: '#16C47F',
    category: 'Clothing',
    productCount: 0,
